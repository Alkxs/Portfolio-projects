  ...
  return (
    <section name='skills'>
      ...
      <div className='container'>
        <div className='skills-card max-w-xs sm:max-w-sm md:max-w-md lg:max-w-3xl xl:max-w-6xl bg-white dark:bg-dark-main w-full flex justify-center items-center rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-black border dark:hover:shadow-white border-gray-200 dark:border-cyan-500'>
